...
renderer.setClearColor('hsl(0, 0%, 10%)');
...
const fragmentShader = glsl(/* glsl */`
  ...
  void main () {
    vec3 color = vec3(
      distance(vUv.y, mod(1.0 / 3.0 + time, 1.0)) > 0.075 ? 1.0 : 0.0,
      distance(vUv.y, mod(2.0 / 3.0 + time, 1.0)) > 0.075 ? 1.0 : 0.0,
      distance(vUv.y, mod(3.0 / 3.0 + time, 1.0)) > 0.075 ? 1.0 : 0.0 
    );
...
const animate = () => {
  ...
  material.uniforms.time.value = count * 0.005
